    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if self.ant is not None and self.ant.can_contain(insect):
                ...
                self.ant = insect
            elif self.ant is not None and insect.can_contain(self.ant) == False and self.ant.can_contain(insect) == False:
                assert False,"Neither Ant can contain the other"
    ...
    def nearest_bee(self, hive):
        ...
        while now_place != None:
            if len(now_place.bees) > 0:
                return random_or_none(now_place)
            else:
...
class FireAnt(Ant):
    ...
    "*** YOUR CODE HERE ***"
    def reduce_armor(self, amount = 2):
        "*** YOUR CODE HERE ***"
        if self.armor <= 0:
