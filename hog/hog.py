...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while score0 < goal and score1 < goal:
        if who:
            ...
            obj_dice = select_dice(score1,score0)
            score1 = score1 + take_turn(num_rolls,score0,obj_dice)
            ...
            obj_dice = select_dice(score0,score1)
            score0 = score0 + take_turn(num_rolls,score1,obj_dice)
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    """
    "*** YOUR CODE HERE ***"
    score_now = 1 + abs(opponent_score % 10 - opponent_score //10)
    if score_now >= margin:
        return 0
    else:
        return num_rolls
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    "*** YOUR CODE HERE ***"
    score_now = 1 + abs(opponent_score // 10 - opponent_score % 10)
    score0 = score1 + score_now
    if opponent_score == 2 * score0:
        return 0
    elif score0 == opponent_score * 2:
        return num_rolls
    elif score_now >= margin:
        return 0
    else:
        return num_rolls
